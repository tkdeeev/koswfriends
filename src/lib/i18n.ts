...
export const copy = {
  ...
  cs: {
    ...
    signOut: "Odhlásit",
    hero: "Rozvrhy ČVUT",
    intro: "Váš rozvrh a přátelé.",
    privacyNotice: "Ochrana osobních údajů",
    termsOfUse: "Podmínky používání",
    signInLegal: "Přihlášením žádáte o účet podle podmínek služby.",
    downloadData: "Stáhnout moje data",
    retentionHint:
      "Účty bez aktivity přihlášeného uživatele po 365 dnech odstraníme, včetně vlastněných skupin.",
    privacy: "Sdílení s každým člověkem ovládáte zvlášť.",
    independent: "Nezávislý studentský projekt, nikoli oficiální služba ČVUT.",
    ...
    you: "Vy",
    comparePeople: "Porovnání rozvrhů",
    together: "Spolu",
  ...
  en: {
    ...
    intro: "Your timetable and friends.",
    privacyNotice: "Privacy notice",
    termsOfUse: "Terms of use",
    signInLegal: "Signing in requests an account under the service terms.",
    downloadData: "Download my data",
    retentionHint:
      "Accounts without signed-in user activity for 365 days are removed, including groups they own.",
    privacy: "You control sharing with each person.",
    independent: "Independent student project, not an official CTU service.",
    preview: "Sample data",
    monday: "Mon",
    tuesday: "Tue",
    wednesday: "Wed",
    ...
    you: "You",
    comparePeople: "Compare timetables",
    together: "Together",
